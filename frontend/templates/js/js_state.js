...
ui_enable_oidc: ({{ ui_config_json | safe }}.enable_oidc === true),
ui_oidc_auto_redirect: ({{ ui_config_json | safe }}.oidc_auto_redirect !== false),
ui_oidc_issuer_url: ({{ ui_config_json | safe }}.oidc_issuer_url || ''),
ui_oidc_client_id: ({{ ui_config_json | safe }}.oidc_client_id || ''),
ui_oidc_client_secret: ({{ ui_config_json | safe }}.oidc_client_secret || ''),
ui_oidc_scopes: ({{ ui_config_json | safe }}.oidc_scopes || 'openid profile email'),
ui_oidc_claim_name: ({{ ui_config_json | safe }}.oidc_claim_name || 'groups'),
ui_oidc_allowed_groups: ({{ ui_config_json | safe }}.oidc_allowed_groups || []),
ui_oidc_cookie_secret: ({{ ui_config_json | safe }}.oidc_cookie_secret || ''),
uiOidcGroupInput: '',
uiOidcShowClientSecret: false,
uiOidcShowCookieSecret: false,
